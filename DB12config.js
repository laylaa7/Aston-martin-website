...
var selectedcolorint = "green";
  ...
  function changeBackgroundImage1(color) {
    const backgroundImage = document.getElementById("background-image"); 
    backgroundImage.style.backgroundImage = `url('DB12img/${color}/int/DB12-1-${color}.jpeg')`;
...
carImages = [
    "DB12img/green/ext/DB12-1-green.jpeg",
    "DB12img/green/ext/DB12-2-green.jpeg",
    "DB12img/green/ext/DB12-3-green.jpeg",
    "DB12img/green/ext/DB12-4-green.jpeg",
    "DB12img/green/ext/DB12-5-green.jpeg",
    "DB12img/green/ext/DB12-6-green.jpeg",
    "DB12img/green/ext/DB12-7-green.jpeg",
    "DB12img/green/ext/DB12-8-green.jpeg",
    "DB12img/green/ext/DB12-9-green.jpeg"
];
...
function selectColor(color) {
    ...
    carImages = [
        `DB12img/${currentColor}/ext/DB12-1-${currentColor}.jpeg`,
        `DB12img/${currentColor}/ext/DB12-2-${currentColor}.jpeg`,
        `DB12img/${currentColor}/ext/DB12-3-${currentColor}.jpeg`,
        `DB12img/${currentColor}/ext/DB12-4-${currentColor}.jpeg`,
        `DB12img/${currentColor}/ext/DB12-5-${currentColor}.jpeg`,
        `DB12img/${currentColor}/ext/DB12-6-${currentColor}.jpeg`,
        `DB12img/${currentColor}/ext/DB12-7-${currentColor}.jpeg`,
        `DB12img/${currentColor}/ext/DB12-8-${currentColor}.jpeg`,
        `DB12img/${currentColor}/ext/DB12-9-${currentColor}.jpeg`
    ];
...
carintimages = [
    "DB12img/grey/int/DB12-1-grey.jpeg",
    "DB12img/grey/int/DB12-2-grey.jpeg",
    "DB12img/grey/int/DB12-3-grey.jpeg",
    "DB12img/grey/int/DB12-4-grey.jpeg"
];
...
function selectColorInt(color) {
    ...
    carintimages = [
        `DB12img/${currentColorint}/int/DB12-1-${currentColorint}.jpeg`,
        `DB12img/${currentColorint}/int/DB12-2-${currentColorint}.jpeg`,
        `DB12img/${currentColorint}/int/DB12-3-${currentColorint}.jpeg`,
        `DB12img/${currentColorint}/int/DB12-4-${currentColorint}.jpeg`
      ];
